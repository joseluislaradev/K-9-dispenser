...
if(isset($_SESSION["correo"])){
    ...
    if ($_SESSION['idDispensador'] != 0) {
        ...
        if (isset($_POST['activarMotor'])) {
            $_SESSION['pagina'] = "configuracionDispensador";
            actualizarEstadoDispensador($idDispensador);
        } 
        
        //Si se activa el boton de un dispensador
        if (isset($_POST['formatearDispensador'])) {
          formatearDispensadores(1, $idDispensador); //Mando 1 para saber que solo es un dispensador, el actual, mandare 2 cuando sean todos
        } 
        ...
        <div class="main-panel">
          ...
          <div class="row">
              <div class="col-md-6 grid-margin stretch-card" align="center">
                <div class="card">
                  <div class="card-body" >
                  <h4 class="card-title">Cambiar credenciales WIFI</h4>
                    <p class="card-description">Cambia el nombre de tu red (SSID) y tu contraseña configurada en el dispensador.</p>
                    <div class="template-demo">
                      <br>
                      <a href="formularioWIFI.php"><button type="button" class="btn btn-danger btn-lg">Cambiar WIFI</button></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6 grid-margin stretch-card" align="center">
                <div class="card">
                  <div class="card-body" >
                  <h4 class="card-title">Formatear dispensador</h4>
                    <p class="card-description">Todos los datos recolectados por el dispensador se ELIMINARAN PERMANENTEMENE. El dispensador podra ser ligado a otra cuenta y reiniciara sus configuraciones.</p>
                    <div class="template-demo">
                      <form action="configuracionDispensador.php" method="POST">
                        <button type="submit" name="formatearDispensador" class="btn btn-danger btn-lg">Formatear dispensador</button>
                      </form>
                    </div>
                  </div>
                </div>
