...
if(isset($_SESSION["correo"])){
    ...
    if ($_SESSION['idDispensador'] != 0) {
        ...
        $cDispensaciones=  C_dispensaciones($idDispensador); ///Consulta para imprimir la tabla con las dispensaciones hechas es decir el historial
          ...
          <div class="content-wrapper">    
              ...
              <div class="col-lg-4 grid-margin stretch-card">   
                <div>        
                  <form action='../Controlador/eliminarInfoDispensacion.php' method='post' enctype='multipart/form-data' id='motor'> 
                    <input type='number' name='eliminarTodos' id='eliminarTodos' value="<?php echo $idDispensador ?>" hidden>
                    <input class="btn btn-danger btn-fw" id='submit_button' type='submit' name='activarMotor' value='ELIMINAR TODOS LOS REGISTROS' />
                  </form>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" align="center">Dispensaciones Realizadas</h4>
                    <br>
                    <p class="card-description">En este lugar podrás observar un registro de todas las dispensaciones hechas en este dispositivo asi como información relevante sobre cada una de ellas. El peso sobrante en plato se obtiene del valor que habia en el plato justo antes de la siguiente dispensación.</p>
                    <br>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th>Comida almacenada sobrante</th>
                            <th>Peso sobrante en plato</th>
                          </tr>
                        </thead>
                        <tbody>

                          <?php echo $cDispensaciones; ?>
