...
if(isset($_SESSION["correo"])){
    ...
    if ($_SESSION['idDispensador'] != 0) {
        ...
        if (isset($_POST['activarMotor'])) {
            $_SESSION['pagina'] = "perfilDispensador";
        ...
        $_SESSION["rutaDispensador"] = $fotoDispensador;
        $ayuda = 0;
        $ayuda2 = 0;

        if(isset($_POST["eliminarFoto"])){
          eliminarImagenDispensador($idDispensador);
        }
        ...
        <div class="main-panel">
          ...
          <div class="row">
            ...
            <div class="col-md-6 grid-margin stretch-card" align="center">
              <div class="card-body">
                <h4 class="card-title">Imagen del Dispensador</h4>
                <div class="template-demo">
                  <form class="forms-sample" id="form2" enctype="multipart/form-data" <?php echo ($ayuda2 == 1)?"action='../Controlador/actualizarPerfilDispensador.php' method='POST'":"action='perfilDispensador.php' method='POST'"?>>
                    <?php if ($ayuda2 == 0){ ?>
                    <div> 
                      <br><br><br>
                      <img src="<?php echo ($fotoDispensador != "")?"$fotoDispensador":"assets/images/perritoElegante.png"?>" alt="">
                      <br><br><br><br>
                    </div>
                    <?php } else { ?>
                      <div class="col-md-6"> 
                    ...
                    <?php if($ayuda == 0){?>
                      ...
                      <?php if($ayuda2 == 1 ){ //Si se envio el formulario?>
                        ...
                        <a href="perfilDispensador.php" class="btn btn-dark" name="cancelarFoto">Cancelar</a>
                      <?php } else { ?>
                        <button type="submit" class="btn btn-primary mr-2" name="editarFoto">Cambiar imagen</button>
                        <?php if($_SESSION["rutaDispensador"] != ""){?>
            ...
            <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" align="center">DATOS DEL DISPENSADOR</h4>
                    <form class="forms-sample" id="form1" <?php echo ($ayuda == 1)?"action='../Controlador/actualizarPerfilDispensador.php' method='POST'":"action='perfilDispensador.php' method='POST'"?>>
                      <div class="form-group">
                        <label for="nombreDispensador">Nombre del dispensador</label>
                        <input type="text" class="form-control" name="nombreDispensador" id="nombreDispensador" value="<?php echo $nombreDispensador;?>" <?php echo ($ayuda == 0)?"disabled style = 'color:rgb(42, 48, 56)'":""; ?>>
                      </div>
                      <div class="form-group">
                        <label for="raza">Raza</label>
                        <input type="text" class="form-control" name="raza" id="raza" value="<?php echo $raza;?>" <?php echo ($ayuda == 0)?"disabled style = 'color:rgb(42, 48, 56)'":""; ?>>
                      </div>
                      <div class="form-group">
                        <label for="peso">Peso (kilogramos)</label>
                        <input type="number" class="form-control" name="peso" id="peso" value="<?php echo $peso;?>" <?php echo ($ayuda == 0)?"disabled style = 'color:rgb(42, 48, 56)'":""; ?>>
                      </div>
                      <div class="form-group">
                        <label for="descripcion">Descripción</label>
                        <input  type="text" class="form-control" name="descripcion" id="descripcion" value="<?php echo $descripcion;?>" <?php echo ($ayuda == 0)?"disabled style = 'color:rgb(42, 48, 56)'":""; ?>>
                      </div>
                      <br>
                      <div align="center">
                      <?php if($ayuda2 == 0){?>
                          <?php if($ayuda == 1){ //Si se envio el formulario?>
                            ...
                            <a href="perfilDispensador.php" class="btn btn-dark" name="cancelar">Cancelar</a>
                          <?php } else { ?>
