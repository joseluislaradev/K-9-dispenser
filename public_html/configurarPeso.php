                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        ...
                        <h6 class="text-muted font-weight-normal"><a href="configurarPeso">Configurar</a></h6>
                      </div>
                      <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
            ...
            <div class="row">
              <div class="col-sm-4 grid-margin">
                <div class="card">
                  ...
                  <img src="<?php echo $fotoDispensador;  ?>" class="rounded-circle"  alt=""> 
                  <br>
                  <p class="text-muted"  align = "center"><?php echo $descripcion; ?></p>
                  <h6 align = "center"><b>Raza: </b><?php echo $raza ?> </h6>
                  <h6 align = "center"><b>Peso: </b> <?php echo $peso ?> kilogramos</h6>
                </div>
              </div>
